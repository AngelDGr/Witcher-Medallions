...
public class AncientWolfMedallionItem extends TrinketItem implements GeoItem, TrinketRenderer {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private final AncientWolfMedallionRenderer renderer = new AncientWolfMedallionRenderer();
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.witcher-medallions.ancientwolfmedalliontp").formatted(Formatting.DARK_GRAY));
