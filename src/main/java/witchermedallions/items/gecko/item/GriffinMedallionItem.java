...
public class GriffinMedallionItem extends TrinketItem implements GeoItem, TrinketRenderer {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public GriffinMedallionItem(Settings settings) {
        super(settings);
    }
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private final GriffinMedallionRenderer renderer = new GriffinMedallionRenderer();
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.witcher-medallions.griffinmedalliontp").formatted(Formatting.YELLOW));
